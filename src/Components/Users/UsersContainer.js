...
import {
    ...
    unFollowAC,
    setCurrentPageAC,
    followingInProgressAC, getUsersThunk, followRequestFunk, unFollowRequestFunk
    ...
    render() {
        ...
        return <div className={style.body}>
            ...
            <Users pages={pages}
                   ...
                   followRequestFunk={this.props.followRequestFunk}
                   unFollowRequestFunk={this.props.unFollowRequestFunk}
